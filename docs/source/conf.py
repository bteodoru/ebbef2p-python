...
NAME_LC = NAME.lower()
NAME_CLI = NAME_LC
COPYRIGHT = '2020, Bogdan Teodoru'
AUTHOR = 'Bogdan Teodoru'
LICENCE_NAME = "MIT"
DESCR_SHORT = "Euler-Bernoulli Beams on Two-Parameter Elastic Foundations"
...
latex_documents = [
    (master_doc, 'ebbef2p.tex', u'ebbef2p Documentation',
     u'Bogdan Teodoru', 'manual'),
]
...
man_pages = [
    (master_doc, 'ebbef2p', u'ebbef2p Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ebbef2p', u'ebbef2p Documentation',
     author, 'ebbef2p', 'One line description of project.',
     'Miscellaneous'),
]
